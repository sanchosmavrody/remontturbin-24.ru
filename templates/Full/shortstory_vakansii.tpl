[group=13]
<div class=" col-md-4" style="line-height: 1.4;">
    <a href="{full-link}" title="Читать подробнее: {title}" class="">
        <strong style="color: #faac3d;  font-size: 19px;" class="title">{title}</strong></a>
    <img src="[xfvalue_thumb_url_vakansii_bg]" alt="">
    <p>{short-story}</p>
</div>

[/group]

<div class="post-item" style="border-bottom: 1px dashed #faac3d;">
    <div class="post-image pull-left" style="max-width: 200px;">
        <img src="[xfvalue_thumb_url_vakansii_bg]" style="width: 100%" alt="" title="">
    </div>
    <h2 class="post-title">
        <a href="{full-link}">{title}</a>
    </h2>
    <div class="post-content">{short-story}</div>
    <div class="post-meta">
        <!-- Author  -->
        <span class="author">
                            <i class="fa fa-user" style="color: #faac3d;"></i> Дирекция</span>
        <!-- Meta Date -->

        <span class="time">
                            <i class="fa fa-calendar" style="color: #faac3d;"></i> [day-news]{date}[/day-news]</span>

        <a href="{full-link}" style="float: right;" class="  btn btn-default ">
            Подробности
        </a>
    </div>
</div>
