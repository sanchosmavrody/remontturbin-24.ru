...
function getStrDate($YFrom)
{


    if (mb_strlen($YFrom) == 6) {
...
function get_breadcrumbcategories($id, $separator = "&raquo;", $last_link = true)
{
    ...
    if ($last_link) {
        ...
        // $list[] = "<span itemprop=\"itemListElement\" itemscope itemtype=\"https://schema.org/ListItem\"><meta itemprop=\"position\" content=\"{pos}\"><a href=\"" . $config['http_home_url'] . get_url($id) . "/\" itemprop=\"item\"><span itemprop=\"name\">{$cat_info[$id]['name']}</span></a></span>";
    ...
    while ($parent_id) {
        ...
        if ($config['allow_alt_url'])
            ...
            $list[] = "<span itemprop=\"itemListElement\" itemscope itemtype=\"https://schema.org/ListItem\"><meta itemprop=\"position\" content=\"{pos}\"><a href=\"" . $config['http_home_url'] . get_url($parent_id) . "/\" itemprop=\"item\"><span itemprop=\"name\">{$cat_info[$parent_id]['name']}</span></a></span>" . $separator;
