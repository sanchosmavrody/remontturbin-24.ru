...
$tpl->result['main'] = str_replace("{manuName}", '', $tpl->result['main']);
$tpl->result['main'] = str_replace("{modelName}", '', $tpl->result['main']);

$tpl->result['main'] = str_replace("{H1}", $H1, $tpl->result['main']);
$tpl->result['main'] = str_replace("{SEO_TEXT}", $SeoText, $tpl->result['main']);
