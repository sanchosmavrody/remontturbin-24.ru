<div class="result__item">
    ...
    <div class="result__count-price">
        <div class="result__price-wrap" style="align-self: center;position: relative;">
            ...
            [leftCount]
            <div style="     position: absolute;    white-space: nowrap;    bottom: -25px;    left: 47px;    color: #d9534f;">
                <i class="fa fa-info-circle"></i>
                Уточняйте наличие, возможно товар в пути
            </div>
            [/leftCount]
            [not-leftCount]
            <div style="     position: absolute;    white-space: nowrap;    bottom: -25px;        right: -108px;    color: #d9534f;">
                <a data-aid="{partId}" style=" color: #d9534f;font-weight: 700; cursor: pointer;text-decoration: underline;" data-maincat="{partType}"
                   class="items__button_ item-card__but_"
                   data-toggle="modal"
                   data-target=".modalOneClick" data-des="{partType} {price}<i class='fa fa-ruble'></i>"
                   data-itemid="{partId}">
                    <i class="fa fa-hand-o-up"></i> Купить в один клик
                </a>
            </div>
            [/not-leftCount]
        </div>
