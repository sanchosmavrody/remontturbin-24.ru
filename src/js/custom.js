...
$(window).load(function () {
    ...
    $('.image-bg').each(function () {
        ...
        if (width === 0 || height === 0) {
            $(this).attr('data-background', "https://via.placeholder.com/" + ('1900') + "x" + ('700') + "/2e2e2e/666.jpg");

            $(this).removeAttr('style');
            $(this).css("background-image", "url(" + "https://via.placeholder.com/1900x700/2e2e2e/666.jpg" + ")");
        }
    });
});
